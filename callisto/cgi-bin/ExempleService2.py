...
os.system("mv ExempleService2_results.txt ../html/"+readconf.portaltemp+"ExempleService2_results.txt")
print ("Content-Type: text/xml\n")
print ("<options>\n")
print("<"+outputs+">"+readconf.portalhost+readconf.portaltemp+"ExempleService2_results.txt</"+outputs+">\n")
print ("</options>\n")
